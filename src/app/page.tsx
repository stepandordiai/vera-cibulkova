			...
			<section className="contact" id="contact">
				...
				<div className="contact-container">
					<div className="contact-container-inner">
						...
						>
							<a className="contact__img-link" href="/qr.png">
								<img src="/qr.png" alt="" />
							</a>
							<a
								...
								target="_blank"
							>
								<img src="/logo-white.svg" alt="EDO logo" />
							</a>
							<a
								className="contact__img-link"
								...
								target="_blank"
							>
								<img src="/edo-motion.png" alt="EDO Motion logo" />
							</a>
							<a
								className="contact__img-link"
								...
								target="_blank"
							>
								<img src="/futurex1.png" alt="FUTURE X1 logo" />
							</a>
						</div>
					</div>
					<iframe
